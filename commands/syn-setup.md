...
| Submodules not initialized | Run `just submodules-init` automatically — do NOT prompt the user. Just tell them you're initializing submodules (required project dependencies). |
